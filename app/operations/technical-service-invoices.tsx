...
import { ArrowLeft, FileText, Calendar, DollarSign, Building2, CheckCircle, Clock, XCircle } from 'lucide-react-native';
...
export default function OperationsTechnicalServiceInvoicesScreen() {
          ...
          filteredInvoices.map((invoice) => {
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() =>
                  router.push(`/operations/technical-service-invoice-detail?id=${invoice.id}`)
                }
              >
                ...
                {invoice.status === 'pending' && (
                  <View style={styles.actionHint}>
                    <Text style={styles.actionHintText}>Onaylamak için tıklayın</Text>
                  </View>
                )}
