  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => router.push('/admin/create-unit-invoice')}>
        ...
        {invoices.map((invoice) => {
          ...
          return (
            <TouchableOpacity
              ...
              onPress={() => router.push(`/admin/unit-invoice-detail?id=${invoice.id}`)}
            >
              <View style={styles.invoiceHeader}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.creatorName}>
                    Oluşturan: {invoice.creator?.full_name}
                  </Text>
                </View>
