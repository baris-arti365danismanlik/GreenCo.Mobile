...
export default function AdminTechnicalRequests() {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Teknik Servis Talepleri</Text>
      </View>
        ...
        {requests.length === 0 ? (
          ...
          requests.map((request) => (
            <TouchableOpacity
              ...
              onPress={() => router.push({ pathname: '/admin/technical-request-detail', params: { id: request.id } })}
            >
