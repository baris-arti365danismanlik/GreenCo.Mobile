/*
  # Add Technical Module Users Can View All Projects

  1. Changes
    - Add SELECT policy for users with 'technical' service module
    - Technical service users need to see all projects to create requests
...
CREATE POLICY "Technical module users can view all projects"
